        ...
        <section className="min-h-0 min-w-0 flex-1 overflow-y-auto">
          ...
          <div className="w-full px-5 pb-12 pt-8 sm:px-7 sm:pb-16 sm:pt-10 md:px-10 lg:px-14 xl:px-20">
            <div className="w-full max-w-5xl">
              ...
              {selectedFile === "hyperledger" && <Hyperledger />}
              {selectedFile === "image-matcher" && <ImageMatcher />}
              {selectedFile === "cloud-monitor" && <CloudMonitor />}
              ...
              {![
                ...
                <p className="text-neutral-500">{selectedFile}</p>
              )}
            </div>
          </div>
        </section>
