    ...
    <article className="max-w-4xl">
      ...
      <div className="mt-3 flex items-center gap-4">
        ...
        <a
          ...
          aria-label="Open Hyperledger project on GitHub"
          title="GitHub"
      ...
      <p className="mt-6 max-w-2xl text-lg leading-8 text-neutral-400">
        A permissioned blockchain network built with Hyperledger Fabric,
        Docker, Linux, and Java chaincode.
      </p>

      <div className="mt-8 flex flex-wrap gap-2">
        {["Java", "Hyperledger Fabric", "Docker", "Linux"].map((tech) => (
          <span
            key={tech}
