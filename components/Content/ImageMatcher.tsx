    ...
    <article className="max-w-4xl">
      ...
      <div className="mt-3 flex items-center gap-4">
        ...
        <a
          ...
          aria-label="Open Image Matcher project on GitHub"
          title="GitHub"
      ...
      <p className="mt-6 max-w-2xl text-lg leading-8 text-neutral-400">
        An image-processing project focused on comparing visual features
        and determining image similarity.
      </p>

      <div className="mt-8 flex flex-wrap gap-2">
        {["Python", "Computer Vision", "Image Processing"].map((tech) => (
